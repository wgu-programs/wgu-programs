...
flowchart LR
    ...
    B([2. Lessons])
    C([3. Outro])
A -- Prepares learner for --> B -- Is tested by --> C
click A "/patterns/structural/intro/"
click B "/components/lessons/"
click C "/patterns/structural/outro/"
```

## 1. Competency Intro
The competency's introduction should welcome the student to the competency and make the case for why the skills they'll learn will be valuable. 
